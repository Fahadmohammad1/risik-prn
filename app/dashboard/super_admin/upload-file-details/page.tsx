        ...
        <div className="p-6 bg-(--f2)">
            ...
            <div className="flex flex-col lg:flex-col md:flex-col xl:flex-row items-left justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <button className="w-48 border border-(--DDDDDB) lg:w-47 xl:w-42.5 transition-all font-creato text-[16px]! flex items-center justify-center gap-2 bg-background text-(--b1) font-normal px-4 py-2.5 leading-4 rounded sm:text-sm cursor-pointer active:scale-95">
                    ...
                    <button
                        ...
                        className="w-48 lg:w-47 xl:w-27 transition-all font-creato text-[16px]! flex items-center justify-center gap-2 bg-(--ff7) text-background font-normal px-4 py-2 leading-4 rounded sm:text-sm cursor-pointer active:scale-95"
                    >
                        <svg
                            width="20"
                            height="20"
                        ...
                        >
                            <path
                                d="M15.8337 4.16699L4.16699 15.8337M4.16699 4.16699L15.8337 15.8337"
                                stroke="white"
                                strokeLinecap="round"
            ...
            <div className="flex flex-col mt-5 gap-8">
                ...
                <div className="flex items-center ">
                    ...
                    <div className="flex items-center flex-wrap divide-x divide-(--DDDDDB)">
                        <div className="px-2">
                            <p className="text-(--c5)">Johor South Field Assessment.pdf</p>
                        </div>

                        <div className="px-2">
                            <p className="text-(--c5)">Uploaded By John Doe</p>
                        </div>

                        <div className="px-2">
                            <p className="text-(--c5)">May 20, 2026</p>
                        </div>

                        <div className="px-2">
                            <p className="text-(--c5)">4.2 MB</p>
                        </div>
                    </div>
                ...
                <div className="flex gap-2">
                    ...
                    <button className="w-48 lg:w-47 xl:w-42.5 transition-all font-creato text-[16px]! flex items-center justify-center gap-2 bg-(--cc) text-(--b1) font-normal px-4 py-2 leading-4 rounded sm:text-sm cursor-pointer active:scale-95">
                        AI Analysis Results
                    </button>
            ...
            <div className="mt-6">
                ...
                <div className="w-full flex flex-col xl:flex-row gap-4 justify-between">
                    ...
                    <div className="w-full xl:w-1/2 main-pie bg-white p-5 sm:p-6 rounded-2xl border border-(--DDDDDB) xl:col-span-2 flex flex-col items-center justify-between">
                        <div className="w-full text-left">
                            <h3 className="font-creato text-xl font-medium leading-5 text-(--b1)">Overall Sentiment</h3>
                        </div>
                        ...
                        <div className="relative w-full mt-2" style={{ height: '240px', overflow: 'hidden' }}>
                            ...
                            <div className="absolute bottom-2 z-4 left-1/2 -translate-x-1/2 text-center w-full">
                                ...
                                <p className="font-creato text-gray-700 text-sm sm:text-base font-normal mt-1">Positive Sentiment</p>
                            </div>
                        </div>
                    ...
                    <div className="w-full xl:w-1/2 flex gap-4 flex-col justify-between">
                        <div className="flex flex-col xl:flex-row gap-4 h-full">
                            ...
                            <div className="w-full h-full p-5 rounded-2xl bg-background border border-(--DDDDDB) justify-between flex flex-col gap-11">
                                <div className="flex gap-2">
                                    <Image
                                        ...
                                        height={30}
                                    />
                                    <p className="font-creato font-medium text-xl lg:text-base xl:text-xl leading-6.5 flex gap-2 items-center text-(--b1)">Sentiment Score</p>
                                </div>

                                <div>
                                    <div className="flex gap-2 items-baseline">
                                        <p className="font-creato text-3xl xl:text-5xl lg:text-3xl md:text-2xl font-normal">08</p>
                                        <p className="font-creato text-sm text-(--b1)">Major Finding</p>
                                    </div>
                                    <div className="flex gap-2">
                                        <Image
                                            src={arrow}
                                        ...
                                        <p className="font-creato text-md text-(--green)">Positive</p>
                                    </div>
                                </div>
                            ...
                            <div className="w-full h-full flex flex-col justify-between gap-11 bg-white p-5 rounded-2xl border border-(--DDDDDB)">
                                <p className="font-creato text-xl lg:text-base xl:text-xl font-medium leading-6.5 flex gap-2 items-center text-(--b1)">
                                    <span>
                                        <Image
                                            src={icon2}
                                            alt={icon2}
                                ...
                                <div className="flex items-end gap-2">
                                    <p className="font-creato text-3xl xl:text-5xl lg:text-3xl md:text-2xl font-normal">0.68</p>
                                    <span className="font-creato text-sm text-(--b1)">Major Finding</span>
                                </div>
                            </div>
                ...
                <div className="w-full mt-4 flex flex-col xl:flex-row gap-4">
                    ...
                    <div className="bg-white w-full xl:w-7/12 p-5 sm:p-6 rounded-2xl border border-(--DDDDDB) xl:col-span-2 flex flex-col justify-between">
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="font-creato text-xl font-medium leading-5 text-(--b1)">Sentiment Trend</h3>
                ...
                <div className="flex flex-col xl:flex-row w-full gap-4 mt-4">
                    ...
                    <div className="w-full xl:w-5/12 bg-white border border-(--DDDDDB) rounded-2xl p-5 flex flex-col">
                        ...
                        <div className="mt-4 sm:mt-6 flex flex-col divide-y divide-gray-100">
                            {DASHBOARD_DATA.riskIndicators.map((item, index) => (
                                ...
                                >
                                    ...
                                    <span
                                        className="inline-flex items-center justify-center px-3.5 py-1 text-xs font-bold roundedtext-center w-19.5"
