                ...
                <div>
                    ...
                    <div className="relative w-full">
                        <input
                            ...
                            className={`input-field w-full pl-10 pr-10 py-2 border bg-[#FFFFFF] border-[#DDDDDB] rounded-[4px] outline-none focus:ring-2 focus:ring-[#22493e] ${newFocused ? "focused" : ""}`}
                        />
                        {/* LOCK ICON */}
                        <div className={`input-icon absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none ${newFocused ? "hidden-icon" : ""}`}>
