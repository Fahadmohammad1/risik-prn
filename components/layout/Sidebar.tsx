  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Sidebar Footer (Live Data & Profile) ── */}
        <div className={`p-6 pr-3 pb-8 flex flex-col gap-6 ${isCollapsed ? "md:px-1.5" : ""}`}>
          
          {/* Live Data Sync Widget */}
          {(!isCollapsed || (typeof window !== "undefined" && window.innerWidth < 768)) ? (
            <div className="bg-(--green) rounded-md p-3 flex flex-col gap-1 shadow-sm">
            ...
            /* Mini-icon alternative fallback when sidebar is collapsed on desktop layout rendering rules */
          ...
          {/* User Profile Block */}
          <div className={`flex items-center ${isCollapsed ? "md:justify-center px-0" : "justify-between px-0"}`}>
            <div className="flex items-center gap-2 min-w-0">
              ...
              {(!isCollapsed || (typeof window !== "undefined" && window.innerWidth < 768)) && (
                <div className="flex flex-col min-w-0 gap-0.5">
                  <span className="font-creato text-base font-normal text-(--b1) leading-5 truncate select-none">
                    John Doe
                  </span>
                  <span className="font-creato text-xs font-medium text-(--c5) leading-4 truncate select-none">
                    john@email.com
                  </span>
                </div>
              )}
            ...
            {/* Selection/Collapse Dropdown Trigger Arrows */}
            {(!isCollapsed || (typeof window !== "undefined" && window.innerWidth < 768)) && (
              <div className="flex flex-col text-[#5C5C5F] pointer-events-none pr-1 select-none scale-75 opacity-70 shrink-0">
